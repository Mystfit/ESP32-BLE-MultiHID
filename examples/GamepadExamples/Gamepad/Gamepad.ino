 ...
 *
 * gamepad->setAxes sets all axes at once. There are a few:
...
void setup()
{
	...
	compositeHID.begin();
    // The default gamepad above enables 16 buttons, all axes, one hat, and no simulation controls or special buttons
}
